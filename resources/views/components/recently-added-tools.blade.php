    ...
    <div class="pt-soft-section relative bg-[#efe5d8] px-5 py-12 sm:px-10">
        ...
        <div class="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            @foreach ($items as $item)
                <article class="pt-soft-card pt-tool-card group p-5 text-left transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg focus-within:-translate-y-0.5 focus-within:shadow-lg">
                    ...
                    <a
                        ...
                        class="pt-link-arrow mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-primary transition-colors duration-200 focus-visible:rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2">
                        Open Tool
                        <span class="pt-link-arrow-icon" aria-hidden="true">&rarr;</span>
                    </a>
                </article>
