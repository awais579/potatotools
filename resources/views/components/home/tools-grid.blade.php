                ...
                <div class="{{ $index > 0 ? 'mt-12 border-stone-200/70 pt-12' : '' }} text-left">
                    ...
                    <div class="mt-7 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        @foreach (($category['tools'] ?? []) as $tool)
                            <article class="pt-soft-card pt-tool-card p-5 text-left transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg focus-within:-translate-y-0.5 focus-within:shadow-lg">
